...
const CategoryDetails = (props) => {
    ...
    useEffect(() => {
        fetch(`https://damp-caverns-66344.herokuapp.com/stores/${props.match.params.store_id}/categories/${props.match.params.category_id}`)
          .then(res => res.json())
          .then(category => {
    ...
    useEffect(() => {
        fetch(`https://damp-caverns-66344.herokuapp.com/stores/${props.match.params.store_id}/categories/${props.match.params.category_id}/offers`)
          .then(res => res.json())
          .then(offers => {
            setOffers(offers)
          })
